...
public class TicketController {
    ...
    public String viewTicketList(HttpSession httpSession, Model model) {
        ...
        List<ViewTicketsListDto> tickets = ticketService.viewTicketList(
            clientId); // 추후 clientId로 변경해야함
    ...
    public String viewSpecificTicket(@PathVariable("ticketNumber") String ticketNumber,
        Model model) {
    ...
    public String makeTickets(HttpSession httpSession) {
        ...
        CreateTicketFinalVo createTicketFinalVo = (CreateTicketFinalVo) httpSession.getAttribute(
            "createTicketFinalVo");

        String clientId = (String) httpSession.getAttribute(Constants.USER_ID_SESSION);
        PaymentType paymentType = (PaymentType) httpSession.getAttribute(Constants.PAYMENT_TYPE);

        String result = ticketService.makeTicketsAndPayment(createTicketFinalVo, clientId,
            paymentType);
    ...
    public String makeTicketsFinalCheck(@ModelAttribute CreateTicketVo createTicketVo,
        HttpSession httpSession, Model model) {
